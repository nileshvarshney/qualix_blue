          ...
          {tab === 'roadmap' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ background: 'var(--surface-muted)', border: '1px solid var(--border)', borderRadius: '10px', padding: '14px 20px', fontSize: '12px', color: 'var(--text-muted)', textAlign: 'center' }}>
                Internal reference only — not shown to end users. All capability statuses verified against source code, June 2026. Last updated: Sensitivity column in Catalog list view (batch fetch), linked glossary terms in asset drawer, stewardship inline approve/reject + custom task creation, audit log JSON export, data lifecycle retention policy UI in Settings Workspace, security page confirmed wired to backend, Data Lifecycle promoted from MISSING → PARTIAL.
              </div>
            </div>
          )}
