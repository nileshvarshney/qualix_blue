...
def upgrade() -> None:
    ...
    if not _table_exists(bind, "ops_escalation_policies"):
        op.create_table(
            ...
            sa.Column("name", sa.String(200), nullable=False),
            sa.Column("description", sa.Text(), nullable=True),
            sa.Column("severity", sa.String(20), nullable=False, server_default="all"),
            sa.Column("steps", sa.Text(), nullable=True),
            sa.Column("oncall_rotation", sa.Text(), nullable=True),
            sa.Column("repeat_interval_minutes", sa.Integer(), nullable=False, server_default="60"),
    ...
    if not _table_exists(bind, "ops_maintenance_windows"):
        op.create_table(
            ...
            sa.Column("suppress_alerts", sa.Boolean(), server_default="true"),
            sa.Column("suppress_scans", sa.Boolean(), server_default="false"),
            sa.Column("created_by", sa.String(200), nullable=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
            sa.Column("updated_at", sa.DateTime(), nullable=True),
        )
    ...
    if not _table_exists(bind, "ops_flap_detection_config"):
        op.create_table(
            ...
            sa.Column("flap_threshold", sa.Integer(), nullable=False, server_default="3"),
            sa.Column("window_minutes", sa.Integer(), nullable=False, server_default="30"),
            sa.Column("suppress_duration_minutes", sa.Integer(), nullable=False, server_default="60"),
